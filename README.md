...
![UML diagram having everything](uml.png)
## Description
...
My project is a base for people who want to sell things on the website. It runs in a way where it gets the quantity, review, and the actural products in it. Although it does not print, it is still a basis for many more projects to come. 